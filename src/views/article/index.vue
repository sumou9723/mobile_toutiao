    ...
    <div class="main-wrap" ref="main">
      ...
      <div v-else-if="article.title" class="article-detail">
        ...
        <van-cell class="user-info" center :border="false">
          ...
          <!-- <follow-user
            class="follow-btn"
            v-bind:isFollowed.sync="article.is_followed"
...
import ArticleComment from './components/article-commit'
...
export default {
  ...
  methods: {
    ...
    goTop() {
      ...
      // if (currentClick - this.lastClick < 300) {
      //   console.log(666)
      //   this.$refs.main.scrollTop = 0
      // } else {
    ...
    postSuccess(data) {
      ...
      this.commitList.unshift(data.new_obj)
    },
    onReplyClick(event) {
